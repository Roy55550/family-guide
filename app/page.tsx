...
const categories = [
  {
    ...
    icon: <Heart className="w-12 h-12 text-[#0F5C5B]" />,
  ...
  },
  {
    ...
    icon: <Users className="w-12 h-12 text-[#0F5C5B]" />,
    color: "bg-[#E8F5E9]",
  ...
  },
  {
    ...
    icon: <Scale className="w-12 h-12 text-[#0F5C5B]" />,
    color: "bg-[#E3F2FD]",
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main>
        ...
        <section className="bg-[#0F5C5B] text-white py-16 md:py-24">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                Navigate Life's Relationships with Expert Guidance
              </motion.h1>
              <motion.p 
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <motion.h2 
              className={`${playfair.className} text-3xl md:text-4xl font-bold mb-12 text-center text-[#0F5C5B]`}
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
            >
              We're Here to Help at Every Stage of Your Relationship
            </motion.h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {categories.map((category, index) => (
                <motion.div 
                  key={index}
                  className={`${category.color} rounded-lg shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl`}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <div className="p-6">
                    ...
                    <h3 className={`${playfair.className} text-2xl font-bold mb-4 text-center text-[#0F5C5B]`}>{category.title}</h3>
                    <p className="mb-6 text-center text-gray-700">{category.description}</p>
